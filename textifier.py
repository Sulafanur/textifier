...
finalform =finalform.replace("ten two" ,"twelve")
finalform =finalform.replace("ten three" ,"thirteen" )
finalform =finalform.replace("ten four" ,"fourteen" )
finalform =finalform.replace("ten five" ,"fifteen " )
finalform =finalform.replace("ten six" ,"sixteen ")
finalform =finalform.replace("ten seven" ,"seventeen " )
finalform =finalform.replace("ten eight" ,"eighteen " )
finalform =finalform.replace("ten nine" ,"nineteen " )
print(finalform)
